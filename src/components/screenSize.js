function ScreenSize () {
  return (
    ...
    <div className=" flex flex-row m-4 h-auto font-bold justify-between text-white bg-yellow-600 sm:bg-red-900 md:bg-green-900 lg:bg-blue-800 xl:bg-violet-500 2xl:bg-orange-700">
